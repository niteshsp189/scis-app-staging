      ...
      {!isInitialLoading && (
        <Form {...form}>
          ...
          >
            ...
            {/* TEST: Add just ONE FormField to see if it causes spacing issue */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FormField
                  ...
                  <FormItem className="space-y-2">
                    <FormLabel className="text-sm font-medium text-gray-700">
                      <FieldLabelWithCount
                        ...
                        maxLength={255}
                        showCount={true}
                        isFocused={focusedFields.has('timezone')}
                      />
                    </FormLabel>
                    ...
                    <FocusedValidationHint
                      isFocused={focusedFields.has('timezone')}
                      hasValue={!!field.value}
                      pattern="Select a timezone from the dropdown"
                      examples={[]}
                    />
                    {!focusedFields.has('timezone') && (
                      <FormMessage className="text-xs" />
                    )}
                  </FormItem>
                )}
