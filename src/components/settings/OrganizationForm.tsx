            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="grid gap-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => form.setValue('timezone', value === "none" ? "" : value)}
                >
                  <SelectTrigger className={cn(
                    ...
                    <SelectValue placeholder="Select a timezone">
                      {form.watch('timezone') ? timezones.find(tz => tz.name === form.watch('timezone'))?.display_name || form.watch('timezone') : "Select a timezone"}
                    </SelectValue>
                  </SelectTrigger>
                  <SelectContent className="max-h-48 overflow-y-auto">
                    <SelectItem value="none">No Timezone</SelectItem>
                    {timezones.map((timezone) => (
                      <SelectItem key={timezone.id} value={timezone.name}>
